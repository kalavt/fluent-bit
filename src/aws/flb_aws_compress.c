...
/* Wrapper function to adapt flb_snappy_compress signature */
static int flb_snappy_compress_wrapper(void *in_data, size_t in_len,
                                       void **out_data, size_t *out_len)
{
    return flb_snappy_compress((char *)in_data, in_len,
 ...
 * 2. Format converters:
 *    - ARROW: DEPRECATED - Arrow is not a proper file format for S3, kept only for compilation
