...
{
#ifdef _WIN32
    SetEnvironmentVariable("AWS_ACCESS_KEY_ID", "dummy-key");
    SetEnvironmentVariable("AWS_SECRET_ACCESS_KEY", "dummy-secret");
    SetEnvironmentVariable("AWS_SESSION_TOKEN", "dummy-token");
    SetEnvironmentVariable("FLB_S3_PLUGIN_UNDER_TEST", "true");
#else
